            ...
            <tbody>
                ...
                <c:forEach var="tagihan" items="${tagihanList}">
                    <tr>
                        ...
                        <td>
                            <a href="tagihan?action=delete&id=${tagihan.id}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin hapus tagihan ini?')">Hapus</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
